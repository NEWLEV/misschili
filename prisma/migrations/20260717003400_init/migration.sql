...
CREATE TABLE `User` (
    ...
    `role` ENUM('CUSTOMER', 'SUPER_ADMIN', 'STORE_MANAGER', 'INVENTORY_MANAGER', 'FULFILLMENT', 'SUPPORT', 'MARKETING', 'EDITOR', 'ACCOUNTANT', 'DEVELOPER', 'AUDITOR') NOT NULL DEFAULT 'CUSTOMER',
...
CREATE TABLE `ProductImage` (
    ...
    INDEX `ProductImage_isFeatured_idx`(`isFeatured`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Payment` (
    ...
    INDEX `Payment_stripePaymentIntentId_idx`(`stripePaymentIntentId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `CouponUsage` (
    ...
    UNIQUE INDEX `CouponUsage_userId_couponId_orderId_key`(`userId`, `couponId`, `orderId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Popup` (
    `id` VARCHAR(191) NOT NULL,
    `type` ENUM('NEWSLETTER', 'EXIT_INTENT', 'PROMOTION', 'COOKIE_CONSENT', 'CART_ABANDONMENT') NOT NULL,
    ...
    `frequency` ENUM('ONCE', 'SESSION', 'DAILY', 'EVERY_VISIT') NOT NULL DEFAULT 'ONCE',
...
CREATE TABLE `SiteSetting` (
    ...
    `value` TEXT NOT NULL,
    `type` ENUM('STRING', 'JSON', 'BOOLEAN') NOT NULL DEFAULT 'STRING',
