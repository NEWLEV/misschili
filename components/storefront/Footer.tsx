  ...
  return (
    ...
    >
      <div className="section-container section-padding">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-(--space-10)">
          {/* Brand Column */}
          <div className="lg:col-span-1">
            <Link href="/" className="inline-flex items-center gap-(--space-3) mb-(--space-4)">
              <Image
              ...
              />
              <span
                className="text-(--text-lg) font-bold"
                style={{ fontFamily: 'var(--font-display)' }}
              >
                Miss Chili
              </span>
            </Link>
            <p className="text-(--text-sm) text-(--color-text-secondary) mb-(--space-5)">
            ...
            <div className="flex gap-(--space-3)">
              <a
                ...
                className="w-10 h-10 flex items-center justify-center rounded-(--radius-md) bg-(--color-surface) hover:bg-(--color-surface-hover) text-(--color-text-secondary) hover:text-(--color-text) transition-colors"
          ...
          {/* Shop Column */}
          <div>
            <h4 className="text-(--text-sm) font-semibold text-(--color-text) uppercase tracking-(--tracking-wider) mb-(--space-4)">
              Shop
            </h4>
            <ul className="flex flex-col gap-(--space-3)">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-(--text-sm) text-(--color-text-secondary) hover:text-(--color-text) transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="mt-(--space-6) flex flex-wrap gap-(--space-2)">
              <div className="flex items-center gap-(--space-1) text-(--text-xs) text-(--color-text-muted)">
