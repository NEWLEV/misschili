...
export default function TermsPage() {
  return (
    <div className="section-container section-padding max-w-3xl">
      <h1 className="text-[var(--text-4xl)] font-bold mb-[var(--space-6)]" style={{ fontFamily: 'var(--font-display)' }}>Terms of Service</h1>
      <div className="space-y-[var(--space-5)] text-[var(--color-text-secondary)]">
        ...
        <h2 className="text-[var(--text-xl)] font-semibold text-[var(--color-text)] mt-[var(--space-6)]">Products & Pricing</h2>
        <p>All prices are listed in USD. We reserve the right to modify prices at any time. Products are subject to availability.</p>
        <h2 className="text-[var(--text-xl)] font-semibold text-[var(--color-text)] mt-[var(--space-6)]">Orders</h2>
        ...
        <h2 className="text-[var(--text-xl)] font-semibold text-[var(--color-text)] mt-[var(--space-6)]">Limitation of Liability</h2>
        ...
        <p>Contact: <a href="mailto:misschilihotsauce@gmail.com" className="text-[var(--color-primary)]">misschilihotsauce@gmail.com</a></p>
      </div>
    </div>
  );
}
