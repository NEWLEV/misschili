...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/products/fiery-heat-ghost-pepper`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/products/spicy-hot-jalapeno-habanero`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
