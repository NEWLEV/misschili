    ...
    <div className="max-w-2xl mx-auto">
      ...
      <form action={async (formData) => {
        ...
        <div>
          ...
          <select name="type" defaultValue={popup.type} className="w-full h-10 px-3 rounded-[var(--radius-md)] bg-[var(--color-bg)] border border-[var(--color-border)]">
        ...
        <div>
          ...
          <textarea name="message" required rows={3} defaultValue={popup.message} className="w-full p-3 rounded-[var(--radius-md)] bg-[var(--color-bg)] border border-[var(--color-border)]"></textarea>
        </div>
        ...
        <div>
          ...
          <select name="frequency" defaultValue={popup.frequency} className="w-full h-10 px-3 rounded-[var(--radius-md)] bg-[var(--color-bg)] border border-[var(--color-border)]">
